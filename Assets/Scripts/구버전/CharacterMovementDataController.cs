...
namespace JY.PlatformerBase
{
    public class CharacterMovementDataController : MonoBehaviour
    {
        ...
        private void InstallPresetData()
        {
            ...
            jump.jumpCutOff = data.jumpCutGravityScale;

            jump.jumpHangGravityScale = data.jumpHangGravityScale;
            jump.jumpHangTimeThreshold = data.jumpHangTimeThreshold;

            jump.maxJumpCount = data.jumpCount;
        }
    }
}
